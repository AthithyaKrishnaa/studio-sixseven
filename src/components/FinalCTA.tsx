      ...
      >
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-8 py-4 rounded-md font-body font-semibold hover:bg-primary/90 transition-colors"
          >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 border border-card/30 text-card px-8 py-4 rounded-md font-body font-semibold hover:bg-card/10 transition-colors"
          >
